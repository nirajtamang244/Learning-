...
x= data[["sepal_length"]]# with only one
y=data[["petal_length"]]
...
user_input= np.array([[5.4]])# the array has to be 2d and not 1d. this is why we used two brackets
...
pickle.dump(prediction, open("tree.pkl", "wb"))  # Save as 'model.pkl'
